...
const INTERNATIONAL_REFRESH_MS = 10 * 60 * 1000;
    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                전 세계 주요 뉴스 · {articles.length}개 기사 · 10분마다 자동 갱신
        ...
        {Object.keys(sourceStats).length > 0 && (
          <div className="mt-3 flex flex-wrap gap-2">
            {Object.entries(sourceStats).map(([source, count]) => (
              <span key={source} className="text-xs px-2 py-1 bg-gray-100 rounded-full text-gray-700">
        ...
        {error && articles.length > 0 && (
          <div className="mt-3 rounded-lg bg-red-50 border border-red-100 px-4 py-2 text-sm text-red-600">
            {error}
          </div>
        )}
      </div>
